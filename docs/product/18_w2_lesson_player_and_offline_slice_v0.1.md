...
- The lesson opens with a preflight that states the objective, target skill, item-ledger evidence path, source boundary, task format, content gate, audio state and local recovery behavior.
